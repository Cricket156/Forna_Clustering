function doBarchart() {
	...
	var y_scale = d3.scale.linear()
		...
		var ypenalty_scale = d3.scale.linear()
			.domain([0, d3.max( clusters_filtered, function (d) { return d[1][2];})])
			.range([height, 0]);
...
//	y_scale.domain([0, d3.max(data, function(d) { return d.frequency; })]);
	...
	draw.append("g")
		...
		// .attr("transform", "translate(0," + margin[2]/2")")
		.text("Cluster number");
...
*/
  ...
  svg.selectAll("rect")
	//TODO: wie selected man alle nebeneinanderliegenden die zu einem cluster gehoeren?
	// gerade wird nur immer das eine rect selected auf das man hovert
    ...
    .on("mousemove", function(d){
        ...
        var elements = document.querySelectorAll(':hover');
				var name = d;
        divTooltip.html(("clusternumber: "+name[1][1]+"<br>")+"overlaps: ".fontcolor("green")+name[1][2]+"<br>"+"stretches: ".fontcolor("red")+name[1][3]+"<br>"+"position: ".fontcolor("blue")+name[1][4]+"<br>"+"nodescount: ".fontcolor("black")+name.length+"<br>");
    })
