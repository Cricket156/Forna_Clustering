...
function doMatrix() {
	...
	svg_direct.attr("width", width)
		...
		// 											.attr("font-size","12px")
		// 											.append("xhtml:body")
		// 		 .html('<div style="width: 500px;">These scatterplot should <br> give you a general overview <br>of the dependencies<br> between different variables<br> in your dataset.<br> Hovering over them<br> will show you information<br> on the datapoints included<br> in one scatterplot. </div>')
		//
